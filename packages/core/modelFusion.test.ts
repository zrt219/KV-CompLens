...
describe("model fusion diagnostics", () => {
  it("normalizes reliability over variance weights and returns finite fused estimate", () => {
    const models: ValuationSubModel[] = [
      { id: "a", label: "Primary evidence", estimate: 700000, variance: 40000 ** 2, reliability: 0.9, rationale: "test" },
      { id: "b", label: "Feature check", estimate: 650000, variance: 90000 ** 2, reliability: 0.6, rationale: "test" },
      { id: "c", label: "Local anchor", estimate: 690000, variance: 80000 ** 2, reliability: 0.5, rationale: "test" }
    ];
